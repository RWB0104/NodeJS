		...
		insertMemo(paramAuthor, paramContents, paramCreateDate, function(err, addedMemo)
		{
			...
			if (addedMemo)
			{
				...
				res.write("\t\t\t<div id=\"titleText\" class=\"header\">처리 결과</div>\n");
	   			res.write("\t\t\t<div id=\"contentsText\" class=\"description\">메모가 저장되었습니다.</div>\n");
				res.write("\t\t\t<div>\n");
				res.write("\t\t\t\t<input type=\"button\" value=\"다시 작성\" onclick=\"javascript:history.back()\" class=\"ui primary button\" />\n");
				res.write("\t\t\t</div>\n");
				res.write("\t\t</div>\n");
				res.write("\t</div>\n");
				res.write("</body>\n");
